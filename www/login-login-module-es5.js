  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(fbauth, loginFormbuilder, valuechecker, toastservice, fbstore, firebaseAuthService, ngroute) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      if (this.loginform.valid) {
                        this.firebaseAuthService.signIn(this.loginform.get('useremail').value, this.loginform.get('userpass').value).then(function (res) {
                          console.log(res);
                        }, function (err) {
                          console.log(err);
                        });
