(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function srcAppRegisterRegisterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _helpers_validation_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(fbauth, signupFormbuilder, valuechecker, toastservice, fbstore, loadingCtrl, firebaseAuthService, ngroute) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      if (this.signupform.valid) {
                        this.firebaseAuthService.signUp(this.signupform.get('nama').value, new Date(this.signupform.get('tgl').value), this.signupform.get('useremail').value, this.signupform.get('userpass').value).then(function (res) {
                          console.log(res);
                        }, function (err) {
                          console.log(err.message);

                          _this.firebaseAuthService.presentToast(err.message, 'danger');
                        });
                      }
