...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, firebaseAuthService, fbstore, ngroute) {
...
/* harmony import */ var _helpers_validation_helpers__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./helpers/validation.helpers */ "./src/app/helpers/validation.helpers.ts");
/* harmony import */ var _fivethree_core__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @fivethree/core */ "./node_modules/@fivethree/core/__ivy_ngcc__/fesm2015/fivethree-core.js");
...
/* harmony import */ var _ionic_pwa_elements_loader__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @ionic/pwa-elements/loader */ "./node_modules/@ionic/pwa-elements/loader/index.es2017.mjs");
/* harmony import */ var src_ionic_gesture_config__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! src/ionic-gesture-config */ "./src/ionic-gesture-config.ts");
...
Object(_ionic_pwa_elements_loader__WEBPACK_IMPORTED_MODULE_17__["defineCustomElements"])(window);
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [
            _fivethree_core__WEBPACK_IMPORTED_MODULE_14__["FivCollapsableModule"],
            _fivethree_core__WEBPACK_IMPORTED_MODULE_14__["FivRouterItemModule"],
            _fivethree_core__WEBPACK_IMPORTED_MODULE_14__["FivExpandableModule"],
        ...
        providers: [
            ...
            _helpers_validation_helpers__WEBPACK_IMPORTED_MODULE_13__["Validator"],
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
            _angular_common__WEBPACK_IMPORTED_MODULE_16__["DatePipe"],
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
            { provide: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["HAMMER_GESTURE_CONFIG"], useClass: src_ionic_gesture_config__WEBPACK_IMPORTED_MODULE_18__["IonicGestureConfig"] }
        ],
...
let AuthService = class AuthService {
    constructor(fireAuth, firebaseDB, toastCtrl, loadingCtrl, fbstore, router) {
    ...
    signUp(Nama, tgl, email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.presentLoading().then(() => {
                return new Promise((resolve, reject) => {
                    ...
                    this.fireAuth.createUserWithEmailAndPassword(email, password)
                        ...
                        yield this.fbstore.doc(path).set({
                            email: email,
                            nama: Nama,
                            tgl: tgl,
                        ...
                        const clr = 'success';
                        yield this.presentToast(msg, clr);
                        this.loading.dismiss();
                        yield this.signIn(email, password);
                    }), err => {
                        reject(err);
...
const environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyAo99QQC5JmedrcNlnyI3EpyT3uSAok0ts",
        authDomain: "sebaruque.firebaseapp.com",
        databaseURL: "https://sebaruque.firebaseio.com",
        projectId: "sebaruque",
        storageBucket: "sebaruque.appspot.com",
        messagingSenderId: "779098180893",
        appId: "1:779098180893:web:b0215d11e1971caadce5f4",
        measurementId: "G-DH9YJNB0KJ"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Serubaqu\src\main.ts */"./src/main.ts");
