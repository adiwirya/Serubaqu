...
AnimateDirective.ɵfac = function AnimateDirective_Factory(t) { return new (t || AnimateDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
AnimateDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: AnimateDirective, selectors: [["", "anim", ""]], inputs: { staggerDelay: ["anim.stagger.delay", "staggerDelay"], delay: ["anim.delay", "delay"], staggerIndex: ["anim.stagger", "staggerIndex"], animIn: ["anim.in", "animIn"], animOut: ["anim.out", "animOut"] } });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AnimateDirective, [{
        type: Directive,
        args: [{
                selector: '[anim]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { staggerDelay: [{
            type: Input,
...
AnimationsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AnimationsModule_Factory(t) { return new (t || AnimationsModule)(); }, providers: [], imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AnimationsModule, { declarations: function () { return [AnimateDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [AnimateDirective]; } }); })();
